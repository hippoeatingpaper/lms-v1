...
```
"Phase 0-1: HTTPS 서버 설정을 구현해줘. SKILL.md를 활용해 코드 스타일을 유지해줘."
```
...
- [ ] `server/middleware/securityFilter.js` (민감 경로 차단)
- [ ] `server/index.js`에 미들웨어 순서대로 적용
...
```
server/CLAUDE.md의 Middleware Order 섹션을 참고해서 Phase 0-5를 구현해줘. SKILL.md를 활용해 코드 스타일을 유지해줘.
```
...
```
server/SPEC_SETUP.md를 읽고 Phase 0-6: CLI 스크립트를 구현해줘. SKILL.md를 활용해 코드 스타일을 유지해줘.
```
...
```
server/middleware/SPEC_AUTH.md를 읽고 Phase 1-1: authenticate 미들웨어를 구현해줘. SKILL.md를 활용해 코드 스타일을 유지해줘.
```
...
- [ ] `requireRole(...roles)` 미들웨어
- [ ] `requireClassAccess` 미들웨어 (반 소속 확인)
- [ ] `requireTeamAccess` 미들웨어 (팀 소속 확인)
...
```
server/middleware/SPEC_AUTH.md를 읽고 Phase 1-2: 역할/반 검증 미들웨어를 구현해줘. SKILL.md를 활용해 코드 스타일을 유지해줘.
```
...
```
server/CLAUDE.md의 Rate Limiting 섹션을 참고해서 Phase 1-3을 구현해줘. SKILL.md를 활용해 코드 스타일을 유지해줘.
```
...
```
server/middleware/SPEC_AUTH.md를 읽고 Phase 2-1: Auth API를 구현해줘. SKILL.md를 활용해 코드 스타일을 유지해줘.
```
...
```
server/routes/SPEC_ADMIN.md를 읽고 Phase 2-2: Classes API를 구현해줘. SKILL.md를 활용해 코드 스타일을 유지해줘.
```
...
```
server/routes/SPEC_ADMIN.md를 읽고 Phase 2-3: Users API를 구현해줘. SKILL.md를 활용해 코드 스타일을 유지해줘.
```
...
```
server/routes/SPEC_ADMIN.md를 읽고 Phase 2-4: Teams API를 구현해줘. SKILL.md를 활용해 코드 스타일을 유지해줘.
```
...
```
server/routes/SPEC_POSTS.md를 읽고 Phase 2-5: Posts API를 구현해줘. SKILL.md를 활용해 코드 스타일을 유지해줘.
```
...
```
server/routes/SPEC_ASSIGNMENTS.md를 읽고 Phase 2-6: Assignments API를 구현해줘. SKILL.md를 활용해 코드 스타일을 유지해줘.
```
...
```
server/routes/SPEC_ASSIGNMENTS.md를 읽고 Phase 2-7: Submissions API를 구현해줘. SKILL.md를 활용해 코드 스타일을 유지해줘.
```
...
```
server/middleware/SPEC_UPLOAD.md를 읽고 Phase 2-8: Files API를 구현해줘. SKILL.md를 활용해 코드 스타일을 유지해줘.
```
...
```
client/CLAUDE.md를 읽고 Phase 3-1: Vite + React 초기화를 구현해줘. SKILL.md를 활용해 코드 스타일을 유지해줘.
```
...
```
client/src/components/ui.tsx를 읽고 누락된 컴포넌트가 있는지 확인해줘. SKILL.md를 활용해 코드 스타일을 유지해줘.
```
...
- [ ] `client/src/lib/api.ts` (API 유틸리티)
...
```
client/CLAUDE.md를 읽고 Phase 3-3: Zustand 스토어를 구현해줘. SKILL.md를 활용해 코드 스타일을 유지해줘.
```
...
- [ ] `client/src/layouts/TeacherLayout.tsx` (사이드바)
- [ ] `client/src/layouts/StudentLayout.tsx` (하단 네비게이션)
...
```
client/CLAUDE.md를 읽고 Phase 3-4: 라우팅과 레이아웃을 구현해줘. SKILL.md를 활용해 코드 스타일을 유지해줘.
```
...
```
client/src/lib/SPEC_AUTH.md를 읽고 Phase 3-5: 로그인 페이지를 구현해줘. SKILL.md를 활용해 코드 스타일을 유지해줘.
```
...
```
Phase 3-6: 대시보드 페이지를 구현해줘. 교사는 반 목록, 학생은 반 홈을 보여줘. SKILL.md를 활용해 코드 스타일을 유지해줘.
```
...
- [ ] `client/src/pages/AdminClasses.tsx`
- [ ] `client/src/pages/AdminUsers.tsx`
- [ ] `client/src/pages/AdminTeams.tsx`
...
```
client/src/pages/SPEC_ADMIN.md를 읽고 Phase 3-7: 관리 페이지를 구현해줘. SKILL.md를 활용해 코드 스타일을 유지해줘.
```
...
- [ ] `client/src/pages/Board.tsx` (목록)
- [ ] `client/src/pages/PostDetail.tsx` (상세)
- [ ] `client/src/pages/PostForm.tsx` (작성/수정)
...
```
client/src/pages/SPEC_POSTS.md를 읽고 Phase 3-8: 게시판 페이지를 구현해줘. SKILL.md를 활용해 코드 스타일을 유지해줘.
```
...
- [ ] `client/src/pages/AssignmentList.tsx`
- [ ] `client/src/pages/AssignmentDetail.tsx`
- [ ] `client/src/pages/AssignmentForm.tsx` (출제 - 교사)
...
```
client/src/pages/SPEC_ASSIGNMENTS.md를 읽고 Phase 3-9: 과제 페이지를 구현해줘. SKILL.md를 활용해 코드 스타일을 유지해줘.
```
...
- [ ] `client/src/pages/SubmissionForm.tsx` (학생 제출)
- [ ] `client/src/pages/SubmissionList.tsx` (교사 - 제출 현황)
- [ ] `client/src/pages/FeedbackForm.tsx` (교사 - 피드백)
...
```
client/src/pages/SPEC_ASSIGNMENTS.md를 읽고 Phase 3-10: 제출/피드백 페이지를 구현해줘. SKILL.md를 활용해 코드 스타일을 유지해줘.
```
...
```
client/src/hooks/SPEC_UPLOAD.md를 읽고 Phase 3-11: 파일 업로드 훅을 구현해줘. SKILL.md를 활용해 코드 스타일을 유지해줘.
```
...
```
server/sockets/SPEC_REALTIME.md를 읽고 Phase 4-1: Socket.IO 서버를 구현해줘. SKILL.md를 활용해 코드 스타일을 유지해줘.
```
...
```
server/sockets/SPEC_REALTIME.md를 읽고 Phase 4-2: 실시간 알림을 구현해줘. SKILL.md를 활용해 코드 스타일을 유지해줘.
```
...
```
client/src/pages/SPEC_REALTIME.md를 읽고 Phase 4-3: Socket.IO 클라이언트를 구현해줘. SKILL.md를 활용해 코드 스타일을 유지해줘.
```
...
```
server/sockets/SPEC_COLLAB.md를 읽고 Phase 4-4: Yjs 서버를 구현해줘. SKILL.md를 활용해 코드 스타일을 유지해줘.
```
...
```
client/src/pages/SPEC_COLLAB.md를 읽고 Phase 4-5: TipTap 에디터를 구현해줘. SKILL.md를 활용해 코드 스타일을 유지해줘.
```
...
```
server/routes/SPEC_ASSIGNMENTS.md의 팀 제출 섹션을 읽고 Phase 5-1을 구현해줘. SKILL.md를 활용해 코드 스타일을 유지해줘.
```
...
```
Phase 5-2: 오프라인 배너를 구현해줘. 네트워크 연결이 끊기면 상단에 배너 표시. SKILL.md를 활용해 코드 스타일을 유지해줘.
```
...
```
Phase 5-3: PWA 설정을 구현해줘. vite-plugin-pwa 사용. SKILL.md를 활용해 코드 스타일을 유지해줘.
```
